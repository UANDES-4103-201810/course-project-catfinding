...
project_7 = Project.create(title: 'Proyecto 7', description: 'kgdskfwvfkhwrgk',goalamount: 200, currentamount: 5, approved: true, deadline: date_6, user: user_2, categories: [catt_1, catt_7])
project_8 = Project.create(title: 'Proyecto 8', description: 'kgdskfwvfkhwrgk',goalamount: 200, currentamount: 5, approved: true, deadline: date_6, user: user_3, categories: [catt_8, catt_4])
