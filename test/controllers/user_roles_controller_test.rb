...
class UserRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_role" do
    assert_difference('UserRole.count') do
      post user_roles_url, params: { user_role: { is_admin: @user_role.is_admin, user_id: @user_role.user_id } }
    end
  ...
  test "should update user_role" do
    patch user_role_url(@user_role), params: { user_role: { is_admin: @user_role.is_admin, user_id: @user_role.user_id } }
